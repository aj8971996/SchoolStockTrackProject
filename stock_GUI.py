        ...
        if (self.stockList.curselection()):
            ...
            for stock in self.stock_list:
                if stock._symbol == symbol:
                    self.headingLabel['text'] = stock._name + " - " + str(stock._shares) + " Shares"
                    ...
                    if count > 0:
                        ...
                        self.stockReport.insert(END,"Profit/Loss: " + "${:,.2f}".format(priceChange * stock._shares) + "\n")
                    else:
